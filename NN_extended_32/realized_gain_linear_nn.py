...
frac = 0.85
norm_mean = "normalizations/realized_gain_extended_32_linear_mean_value.pkl"
norm_std = "normalizations/realized_gain_extended_32_linear_std_value.pkl"
param = 'parameters/realized_gain_extended_32_linear_parameters.pkl'

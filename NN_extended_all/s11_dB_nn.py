...
drop_rates = [0.2]
frac = 0.85
norm_mean = "normalizations/s11_extended_all_dB_mean_value.pkl"
norm_std = "normalizations/s11_extended_all_dB_std_value.pkl"
param = 'parameters/S11_extended_all_parameters_dB.pkl'
...
parameters = model(train_set_x, train_set_y, test_set_x, test_set_y, W, activations,learning_rate = 0.0005, num_epochs = 100000, dropout_layers = drop_layers, dropout_rates = drop_rates)

...
hidden layers = 4 
neurons in each layer = 7, 7, 7, 7 (tanh, tanh, tanh, relu)
...
frac = 0.85
norm_mean = "normalizations/realized_gain_all_dB_mean_value.pkl"
norm_std = "normalizations/realized_gain_all_dB_std_value.pkl"
param = 'parameters/realized_gain_all_dB_parameters.pkl'
...
parameters = model(train_set_x, train_set_y, test_set_x, test_set_y, W, activations, learning_rate = 0.0009, num_epochs = 500000, print_errors = True, gpu = True)

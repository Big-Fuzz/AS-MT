...
number of epochs = 50000 early stopping for regularizing
'''
...
for j in range(Kfold_epochs):
    ...
    for i in range(splits):
        ...
        parameters, err_train, err_test = model(train_set_x, train_set_y, test_set_x, test_set_y, W, activations, learning_rate = 0.0035, num_epochs = 500000, b1 = 0.95, get_errors = True, show_plots = False, print_cost = False, print_errors = False)
...
print("Average test error for S11 parameters in linear values is:", mean_means_of_test_errors)
print("Average test accuracy for S11 parameters in linear values is:", 1 - mean_means_of_test_errors)
print("Average train error for S11 parameters in linear values is:", mean_means_of_train_errors)
print("Average train accuracy for S11 parameters in linear values is:", 1 - mean_means_of_train_errors)

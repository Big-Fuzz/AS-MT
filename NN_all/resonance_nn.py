...
frac = 0.8
norm_mean = "normalizations/resonance_all_mean_value.pkl"
norm_std = "normalizations/resonance_all_std_value.pkl"
param = "parameters/resonance_all_parameters.pkl"
...
parameters = model(train_set_x, train_set_y, test_set_x, test_set_y, W, activations,learning_rate = 0.0025, num_epochs = 360000, b1 = 0.95)

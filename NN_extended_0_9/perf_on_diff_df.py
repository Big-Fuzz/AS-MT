...
################################################################### Givens:
data = "datasets/Data_final_test.csv"
norm_mean = "normalizations/s11_extended_0_9_linear_mean_value.pkl"
norm_std = "normalizations/s11_extended_0_9_linear_std_value.pkl"
param = 'parameters/S11_extended_0_9_parameters_linear.pkl'
...
list_of_outputs = ['s11']
dB = False # for dB values or Resonance
...
if data == "datasets/Data_with_header.csv" and list_of_inputs[len(list_of_inputs)-1] == 'resonance':
    data_x[len(list_of_inputs)-1] = data_x[len(list_of_inputs)-1]/(1000000000)
    print("resonance")
    
if data == "datasets/Data_with_header.csv" and list_of_outputs == ['resonance']:
    data_y = data_y / 10**9 
    print("resonance")

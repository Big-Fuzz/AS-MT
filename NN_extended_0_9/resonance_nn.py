...
hidden layers = 5 relu x 5
neurons in each layer = 9
...
frac = 0.85
norm_mean = "normalizations/resonance_extended_0_9_mean_value.pkl"
norm_std = "normalizations/resonance_extended_0_9_std_value.pkl"
param = "parameters/resonance_extended_0_9_parameters.pkl"
...
parameters = model(train_set_x, train_set_y, test_set_x, test_set_y, W, activations,learning_rate = 0.0085, num_epochs = 360000)

...
drop_rates = [0.2]
frac = 0.85
norm_mean = "normalizations/s11_extended_0_9_dB_mean_value.pkl"
norm_std = "normalizations/s11_extended_0_9_dB_std_value.pkl"
param = 'parameters/S11_extended_0_9_parameters_dB.pkl'

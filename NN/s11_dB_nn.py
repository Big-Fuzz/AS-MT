...
parameters = model(train_set_x, train_set_y, test_set_x, test_set_y, W, activations,learning_rate = 0.0005, num_epochs = 300000, dropout_layers = drop_layers, dropout_rates = drop_rates)

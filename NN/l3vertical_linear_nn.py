...
drop_rates = []
frac = 0.85
norm_mean = "normalizations/l3v_linear_mean_value.pkl"
norm_std = "normalizations/l3v_linear_std_value.pkl"
param = 'parameters/l3v_linear_parameters.pkl'
...
parameters = model(train_set_x, train_set_y, test_set_x, test_set_y, W, activations,learning_rate = 0.001, num_epochs = 200000)

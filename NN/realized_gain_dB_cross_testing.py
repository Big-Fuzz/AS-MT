...
for j in range(Kfold_epochs):
    ...
    for i in range(splits):
        ...
        parameters, err_train, err_test = model(train_set_x, train_set_y, test_set_x, test_set_y, W, activations, learning_rate = 0.0085, num_epochs = 360000, get_errors = True, show_plots = False)

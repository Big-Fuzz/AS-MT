...
norm_mean = "normalizations/s11_dB_mean_value.pkl"
norm_std = "normalizations/s11_dB_std_value.pkl"
param = 'parameters/S11_parameters_dB.pkl'
...
if data == "datasets/Data_with_header.csv"and list_of_outputs[0] == 'resonance':
    data_y = data_y / 10**9 
    print("resonance")

...
Kfold_epochs = 4
hidden layers = 5 (tanh, tanh, relu, relu, relu)
...
for j in range(Kfold_epochs):
    ...
    for i in range(splits):
        ...
        parameters, err_train, err_test = model(train_set_x, train_set_y, test_set_x, test_set_y, W, activations, learning_rate = 0.0005, num_epochs = 200000, get_errors = True, show_plots = False)
...
print("Average test error for s11 parameters in linear values on NN_dataset is:", mean_means_of_test_errors)
print("Average test accuracy for s11 parameters in linear values on NN_dataset is:", 1 - mean_means_of_test_errors)
print("Average train error for s11 parameters in linear values on NN_dataset is:", mean_means_of_train_errors)
print("Average train accuracy for s11 parameters in linear values on NN_dataset is:", 1 - mean_means_of_train_errors)

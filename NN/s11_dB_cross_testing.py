...
for j in range(Kfold_epochs):
    ...
    for i in range(splits):
        ...
        parameters, err_train, err_test = model(train_set_x, train_set_y, test_set_x, test_set_y, W, activations, learning_rate = 0.0005, num_epochs = 300000, get_errors = True, show_plots = False, dropout_layers = drop_layers, dropout_rates = drop_rates)
...
print("Average test error for S11 parameters in dB on NN_dataset is:", mean_means_of_test_errors)
print("Average test accuracy for S11 parameters in dB on NN_dataset is:", 1 - mean_means_of_test_errors)
print("Average train error for S11 parameters in dB on NN_dataset is:", mean_means_of_train_errors)
print("Average train accuracy for S11 parameters in dB on NN_dataset is:", 1 - mean_means_of_train_errors)

...
frac = 0.85
norm_mean = "normalizations/realized_gain_dB_mean_value.pkl"
norm_std = "normalizations/realized_gain_dB_std_value.pkl"
param = 'parameters/realized_gain_dB_parameters.pkl'

...
frac = 0.85
norm_mean = "normalizations/realized_gain_extended_3_2_linear_mean_value.pkl"
norm_std = "normalizations/realized_gain_extended_3_2_linear_std_value.pkl"
param = 'parameters/realized_gain_extended_3_2_linear_parameters.pkl'
